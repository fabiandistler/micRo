...
Thanks for using micRo! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/fabiandistler/micRo/issues/new).
...
requests](https://github.com/fabiandistler/micRo/issues) to make sure
