...
This outlines how to propose a change to micRo. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("fabiandistler/micRo", fork = TRUE)`.
...
Please note that the micRo project is released with a [Contributor Code
of Conduct](https://fabiandistler.github.io/micRo/CODE_OF_CONDUCT.md).
